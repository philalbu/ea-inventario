...
export function ProductForm({ onSubmit, onCancel, categories, locations, initialData, isSubmitting }: ProductFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        {imagePreview ? (
          ...
          <button type="button" onClick={() => fileRef.current?.click()}
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-400 mt-0.5">PNG, JPG, WEBP até 5MB</p>
            </div>
      ...
      <Input label="Nome do Produto *" placeholder="Ex: Shampoo Premium 500ml" error={errors.name?.message} {...register('name')} />

      <div className="grid grid-cols-2 gap-4">
        <Input label="Quantidade *" type="number" min={0} placeholder="0" error={errors.quantity?.message} {...register('quantity')} />
      ...
      <Textarea label="Descrição (opcional)" placeholder="Informações adicionais sobre o produto..." rows={3} {...register('description')} />
