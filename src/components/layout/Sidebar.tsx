  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className={cn(
        ...
        {!collapsed && (
          <div>
            <span className="text-white font-bold text-lg leading-none">Inventário</span>
      ...
      {/* User + Logout */}
      <div className={cn('px-2 py-4 border-t border-primary-700', collapsed && 'flex justify-center')}>
        {!collapsed && (
          <div className="px-3 py-2 mb-2">
            <p className="text-xs text-primary-300">Logado como</p>
            <p className="text-sm font-medium text-white truncate">ederson.albuquerque</p>
          </div>
        )}
        <button
          onClick={signOut}
  ...
  return (
    <>
      ...
      >
        ...
        >
          <ChevronRight className={cn('h-3.5 w-3.5 text-gray-600 transition-transform', collapsed ? '' : 'rotate-180')} />
        </button>
      </aside>
